namespace PassArgument {
    
    #line 21 "C:\Xamarin-Drive-Samples\WF\HelloWorld\AsyncInvoke\Workflow1.xaml"
    using System;
    
    #line default
    #line hidden
    
    #line 1 "C:\Xamarin-Drive-Samples\WF\HelloWorld\AsyncInvoke\Workflow1.xaml"
    using System.Collections;
    
    #line default
    #line hidden
    
    #line 22 "C:\Xamarin-Drive-Samples\WF\HelloWorld\AsyncInvoke\Workflow1.xaml"
    ...
    #line 23 "C:\Xamarin-Drive-Samples\WF\HelloWorld\AsyncInvoke\Workflow1.xaml"
    using System.Data;
    
    #line default
    #line hidden
    
    #line 24 "C:\Xamarin-Drive-Samples\WF\HelloWorld\AsyncInvoke\Workflow1.xaml"
    using System.Linq;
    
    #line default
    #line hidden
    
    #line 25 "C:\Xamarin-Drive-Samples\WF\HelloWorld\AsyncInvoke\Workflow1.xaml"
    using System.Text;
    
    #line default
    #line hidden
    
    #line 26 "C:\Xamarin-Drive-Samples\WF\HelloWorld\AsyncInvoke\Workflow1.xaml"
    using PassArgument;
    ...
    public partial class Workflow1 : System.Activities.XamlIntegration.ICompiledExpressionRoot {
        ...
        private class Workflow1_TypedDataContext1_ForReadOnly : Workflow1_TypedDataContext0_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr0GetTree() {
                ...
                #line 51 "C:\XAMARIN-DRIVE-SAMPLES\WF\HELLOWORLD\ASYNCINVOKE\WORKFLOW1.XAML"
        ...
        private class Workflow1_TypedDataContext2 : Workflow1_TypedDataContext1 {
            ...
            protected PassArgument.Person varCandidate {
                get {
                    return ((PassArgument.Person)(this.GetVariableValue((3 + locationsOffset))));
                }
                set {
            ...
            public new static bool Validate(System.Collections.Generic.IList<System.Activities.LocationReference> locationReferences, bool validateLocationCount, int offset) {
                ...
                if (((locationReferences[(offset + 3)].Name != "varCandidate") 
                            || (locationReferences[(offset + 3)].Type != typeof(PassArgument.Person)))) {
                    return false;
                }
        ...
        private class Workflow1_TypedDataContext2_ForReadOnly : Workflow1_TypedDataContext1_ForReadOnly {
            ...
            internal System.Linq.Expressions.Expression @__Expr1GetTree() {
                ...
                #line 61 "C:\XAMARIN-DRIVE-SAMPLES\WF\HELLOWORLD\ASYNCINVOKE\WORKFLOW1.XAML"
                System.Linq.Expressions.Expression<System.Func<PassArgument.Person>> expression = () => 
            varCandidate;
            ...
            [System.Diagnostics.DebuggerHiddenAttribute()]
            public PassArgument.Person @__Expr1Get() {
            ...
            public PassArgument.Person ValueType___Expr1Get() {
                this.GetValueTypeValues();
            ...
            internal System.Linq.Expressions.Expression @__Expr2GetTree() {
                ...
                #line 66 "C:\XAMARIN-DRIVE-SAMPLES\WF\HELLOWORLD\ASYNCINVOKE\WORKFLOW1.XAML"
